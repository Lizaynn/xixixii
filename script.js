...
if (url.searchParams.get('yangg') != null) {
  sender = url.searchParams.get('hii sayangkuu aku mo alay dikit yeuh:v');
} else {
  sender = "Lzzz";
}
      ...
      Swal.fire("Awasss yaaa kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${aswil} kamuu sayang ga sama ${Lzzzz}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${aswill:v}`).then(function () {
                Swal.fire({
